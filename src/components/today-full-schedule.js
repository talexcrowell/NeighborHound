...
import {fetchAiringTodayTV, closeDetails, viewDetails, fetchTVPage} from '../actions/rex';
import Details from './details';
import ScheduleList from './schedule-list';

export class TodayFullSchedule extends React.Component {
  componentDidMount() {
  ...
  render() {
    ...
    if(this.props.loading === true){
      ...
      list = <ScheduleList media={airingToday} nextPage={() => this.changeNextPage()} prevPage={() => this.changePrevPage()}/>
    }
      ...
      return(
        ...
        <section className='full-schedule-categories'>
          <Link className='click-area' to='/rex/schedules/tv/today'><div className='full-schedule-category-active'>Within Next 24 Hours:</div></Link>
...
export default connect(mapStateToProps)(TodayFullSchedule);